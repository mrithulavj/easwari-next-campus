  ...
  const handleAction = async (
    ...
    try {
      ...
      const updateData: any = {
        ...
        hod_approved_by: hodData?.id,
      };

      if (comments[applicationId]) {
        updateData.hod_comments = comments[applicationId];
      }
      ...
      if (
        ...
        app?.coordinator_status === "approved"
      ) {
    ...
    <div className="min-h-screen bg-background p-4">
      <div className="max-w-6xl mx-auto">
        <div className="mb-6">
          ...
          <p className="text-muted-foreground">Review and manage OD applications</p>
        </div>
              ...
              <CardContent className="space-y-4">
                ...
                {app.hod_comments && (
                  <div className="pt-4 border-t">
                    <p className="font-medium text-sm">HOD Comments:</p>
                    <p className="text-sm text-muted-foreground">{app.hod_comments}</p>
                  </div>
                )}
              </CardContent>
            </Card>
